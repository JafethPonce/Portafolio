...
<div class="container">
      <h3 class="mt-5"><center>Caja de comentarios</center></h3>
      <hr>
      <div class="row">
...
<div class="input-row">
    ...
    <input class="form-control" type="text" name="name" id="name" placeholder="Nombre completo" style="border-radius: 40px;"/>
</div>

<div class="input-row">
    <p class="emoji-picker-container" >
      <textarea class="input-field" data-emojiable="true" data-emoji-input="unicode" type="text" name="comment" id="comment" placeholder="Agregar mi comentario" ></textarea>
    </p>
</div>
...
function (data) {
	...
	for (var i = 0; (i < data.length); i++)
	{
		...
		if (parent == "0")
		{
			...
			"<div class='comment-info'><img src='user.png'><span class='posted-by'>" + data[i]['comentario_nombre'].toUpperCase() + "<div class='comment-text'>" + data[i]['fecha'] +  "</div>"+ "</span></div>" + 
...
<footer class="footer">
      <div class="container"> <span class="text-muted">
        <p>Fuente: <a href="" target="_blank">Jafeth Ponce</a></p>
        </span> </div>
    </footer>
